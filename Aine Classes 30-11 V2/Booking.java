...
public class Booking {
    ...
    /**
     * method that gets the stars of the hotel
     * 
     * @return int
     */
    public int getStar() {
    ...
    public void bookRooms(Calender calender) {
        ...
        for (Reservation r : roomsToReserve) {
            ...
            Reservation res = new Reservation(star, reservationNumber, reservationName, rType, checkIn, checkOut, roomType, occupancy);
