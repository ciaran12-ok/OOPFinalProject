...
public class Booking {
    ...
    public Booking(String reservationNumber, String reservationName, ReservationType rType, ResDate checkIn, ResDate checkOut, Reservation[] roomsToReserve, Room[] roomsToBook) {
    ...
    public Booking() {
        ...
        //this.reservationNumber = rNum;
         //bookingNo+= 1 ;
        this.reservationNumber= String.valueOf(bookingNo);
    }
