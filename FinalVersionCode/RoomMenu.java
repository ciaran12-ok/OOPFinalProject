            ...
            if (entry1 == 1) {
                ...
                if (command1 == 1) {
                    ...
                    for (int i = 0; i < numOfRooms; i++) {
                        ...
                        //NOTE WE COULDN'T GET IT TO CHECK WHETHER A ROOM WAS BOOKED OUT WORKING
//                        LocalDate dayIn = LocalDate.of(booking.getCheckIn().getYear(), 
//                                booking.getCheckIn().getMonth(),booking.getCheckIn().getDay());
//                        int dayOfYearIn = dayIn.getDayOfYear();
//
//                        LocalDate dayOut = LocalDate.of(booking.getCheckOut().getYear(), 
//                                booking.getCheckOut().getMonth(),booking.getCheckOut().getDay());
...
//                        }
                ...
                if (entry1 == 4) {
                    ...
                    String[][] reservationInfo = file1.readReservations();
            ...
            Data Analysis looking at the 3 star hotel
                ...
                if (entry1 == 2) {
                    ...
                    Reservation res = calender.lookBooking(entry2);
                ...
                if (entry1 == 3) {
                    ...
                    Reservation res = calender.lookBooking(entry3);
                    calender.removeReservation(res);
                    System.out.println("Your Reservation had been cancelled");
                }
                if (entry1 == 0) {
                    System.exit(0);
                }
